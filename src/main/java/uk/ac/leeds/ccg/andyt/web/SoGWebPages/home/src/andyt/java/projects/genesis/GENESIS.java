package uk.ac.leeds.ccg.andyt.web.SoGWebPages.home.src.andyt.java.projects.genesis;
...
public class GENESIS extends WebContentWriter {
    ...
    public void run() {
        String _BaseURL = "http://www.geog.leeds.ac.uk/people/a.turner/src/andyt/java/projects/GENESIS/";
        //String _Directory = "C:/Work/src/andyt/java/web/src/uk/ac/leeds/ccg/andyt/web/SoGWebPages/home/src/andyt/java/projects/GENESIS/";
        String _Directory = "Z:/a.turner/src/andyt/java/projects/GENESIS/";
        String _FilenamePrefix = "GENESIS";
        String _FilenameSuffix = "";
        String _PageTitle = "Andy Turner's GENESIS Source Code Web Page";
    ...
    public void writeHTMLBodyMain1(
        ...
        a_FileOutputStream.write( ("<li>Information about a library of packages for Modelling and Simulation for e-Social Science. " +
                "This began to evolve in July 2005 as <a href=\"http://www.geog.leeds.ac.uk/people/a.turner/projects/GENESIS/\">GENESIS</a> got underway. " +
        ...
        a_FileOutputStream.write( "<ul>".getBytes() );
        a_FileOutputStream.write( lineSeparator );
        a_FileOutputStream.write( "<li><a href=\"./dist/GENESIS.jar\" title=\"Java Archive File of Classes\">Java Archive File of Classes</a></li>".getBytes() );
        a_FileOutputStream.write( lineSeparator );
        ...
        a_FileOutputStream.write( lineSeparator );
        a_FileOutputStream.write( ("<li><a href=\"./releases/GENESIS_" + _ReleaseVersion + ".zip\" title=\"GENESIS_" + _ReleaseVersion + " Software Bundle\">GENESIS_" + _ReleaseVersion + " Software Bundle</li>").getBytes() );
        a_FileOutputStream.write( lineSeparator );
        a_FileOutputStream.write( "</ul></li>".getBytes() );
        a_FileOutputStream.write( lineSeparator );
        ...
        a_FileOutputStream.write( "<ul>".getBytes() );
        a_FileOutputStream.write( lineSeparator );
        a_FileOutputStream.write( "<li>RES-149-25-0034 (<a href=\"http://www.ncess.ac.uk/research/nodes/GENESIS/\" title=\"ESRC National Centre for e-Social Science - Nodes: GENESIS\">GENESIS</a>)</li>".getBytes() );
        a_FileOutputStream.write( lineSeparator );
        a_FileOutputStream.write( "</ul></li>".getBytes() );
        a_FileOutputStream.write( lineSeparator );
